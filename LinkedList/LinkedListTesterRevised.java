...
//--- 메뉴 선택 ---//
   static Menu SelectMenu() {
      ...
      do {
         System.out.println();
         System.out.println("[LinkedList 구현체 입니다.]");
         for (Menu m : Menu.values()) {
   ...
   public static void main(String[] args) {
      ...
      LinkedListRevised list = new LinkedListRevised(); // 리스트를 생성
      ...
      do {
         ...
         case SEARCH_NO: // 회원 번호 검색
            ...
            ptr = (Data) list.search(temp, Data.NO_ORDER);
            if (ptr == null)
         ...
         case SEARCH_NAME: // 이름 검색
            ...
            ptr = (Data) list.search(temp, Data.NAME_ORDER);
            if (ptr == null)
